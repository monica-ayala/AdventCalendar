  ...
  return (
    <div className="group h-80 w-58 [perspective:1000px] mb-4">
      <div className="relative h-full w-full rounded-xl shadow-xl transition-all duration-1000 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]">
        <div
          className={color === 'red' ? `absolute inset-0 h-full w-full rounded-xl bg-[url('../assets/imgs/red-card.png')] bg-no-repeat bg-cover px-12 text-center` : `absolute inset-0 h-full w-full rounded-xl bg-[url('../assets/imgs/white-card.png')] bg-no-repeat bg-cover px-12 text-center`}
        >
